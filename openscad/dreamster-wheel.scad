...
timingHolePad  = 0; // The [inside,middle,outside] padding for the timing holes
...
spokeInset        = [6,0];      // The [inner,outer] inset of the spoke area from the surface
...
hubDiameter          = 12;    // The diameter of the hub portion of the wheel
hubHeight            = 12;    // The total height of the hub
hubZOffset           = -2.01;     // The Z position of the hub, negative numbers from the surface of the wheel 
...
outerNutTrap         = 0;   // Size [indiameter, depth] of a captive nut, or 0 (any) for none.
